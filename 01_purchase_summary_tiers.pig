...
name,
ID,
buy1+buy2+buy3+buy4+buy5+buy6+buy7+buy8+buy9+buy10 as SUM:float,
...
AVG,(
	CASE
		WHEN AVG>5000 THEN 'High average'
		WHEN AVG<4100 THEN 'Low average'
		WHEN AVG>4101 THEN 'Mid average'
	END);
	
DESCRIBE data2;
SH echo '********************************************** data2  ***********************************';

data3 = ORDER data2 BY AVG DESC;
DESCRIBE data3;
SH echo '********************************************** data3  ***********************************';
DUMP data3;
